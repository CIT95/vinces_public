...
while True:
    ...
    try:
        if startingnumber >= endingnumber:
            raise Exception #bring up an error if startingnumber >= endingnumber

    except ValueError:
        print('Error: No integer was entered.') #When input !- integer
        continue

    except Exception:
        print('Starting input must be greater than the ending input.')# startingnumber >= endingnumber
        continue
